    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_sn', models.CharField(default='', max_length=50, verbose_name='商品统一货号')),
                ...
                ('goods_desc', DjangoUeditor.models.UEditorField(default='在此填写商品描述', verbose_name='内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父目录', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类目')),
            ],
            options={
                'verbose_name': '商品类别',
